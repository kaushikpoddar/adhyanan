...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style2">
        <tr>
            <td class="auto-style18" colspan="6" style="text-align: center"><span class="newStyle21">&nbsp;&nbsp; <span class="auto-style14">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Administrator Registration&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>&nbsp;</span></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style62" colspan="2">
                <asp:TextBox ID="txtName" runat="server" BackColor="White" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="22px" Width="242px"></asp:TextBox>
            </td>
            <td class="auto-style63">
