<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FrgtAdmin.aspx.cs" Inherits="FrgtAdmin" %>
    ...
    <table class="auto-style2">
        ...
        <tr>
            ...
            <td class="auto-style10">
                <asp:ImageButton ID="ImageButton1" runat="server" Height="27px" ImageUrl="~/images/go_next_black.png" PostBackUrl="~/SignInAdmin.aspx" Width="27px" />
            </td>
            <td class="auto-style10"></td>
        </tr>
        <tr>
